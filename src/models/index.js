...
const EstudianteEvento = require("./estudianteEvento.model")(
  sequelize,
  DataTypes
);
...
const SubCalificacion = require("./subCalificacion.model")(
  sequelize,
  DataTypes
);
const DocenteProyecto = require("./docenteProyecto.model")(
  sequelize,
  DataTypes
);
const Area = require("./area.model")(sequelize, DataTypes);
const AreaCategoria = require("./areaCategoria.model")(sequelize, DataTypes);
