...
// GET /api/docente-proyectos/mis-proyectos-jurado - Obtener proyectos donde soy jurado de la feria activa
router.get(
  "/mis-proyectos-jurado",
  validarToken,
  docenteProyectoController.obtenerMisProyectosComoJurado
);

// GET /api/docente-proyectos/proyecto/:idProyecto - Obtener docentes de un proyecto
router.get(
  "/proyecto/:idProyecto",
  docenteProyectoController.obtenerDocentesPorProyecto
);

// GET /api/docente-proyectos/docente/:idDocente - Obtener proyectos de un docente
router.get(
  "/docente/:idDocente",
  docenteProyectoController.obtenerProyectosPorDocente
);

// GET /api/docente-proyectos/:idDocenteProyecto - Obtener asignación por ID
router.get(
  "/:idDocenteProyecto",
  docenteProyectoController.obtenerAsignacionPorId
);

// PUT /api/docente-proyectos/:idDocenteProyecto - Actualizar asignación
router.put(
  "/:idDocenteProyecto",
  docenteProyectoController.actualizarAsignacion
);

// DELETE /api/docente-proyectos/:idDocenteProyecto - Eliminar asignación
router.delete(
  "/:idDocenteProyecto",
  docenteProyectoController.eliminarAsignacion
);
